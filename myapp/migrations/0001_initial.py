    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lat', models.DecimalField(blank=True, decimal_places=7, max_digits=11, null=True)),
                ('long', models.DecimalField(blank=True, decimal_places=7, max_digits=11, null=True)),
                ('division', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='district', to='myapp.division')),
            ],
            options={
                'ordering': ['-created_at', '-updated_at'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lat', models.DecimalField(blank=True, decimal_places=7, max_digits=11, null=True)),
                ('long', models.DecimalField(blank=True, decimal_places=7, max_digits=11, null=True)),
                ('district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='upazila', to='myapp.district')),
            ],
            options={
                'ordering': ['-created_at', '-updated_at'],
                'abstract': False,
